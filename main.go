...
func (h *Handler) mqttOut(client mqtt.Client, msg mqtt.Message) {
	...
	case "weatherapi/out":
		...
		h.statsd.Gauge(1.0, fmt.Sprintf("heerhugowaard2.%s.wind_bearing", update.TimeStr), fmt.Sprintf("%d", update.WindBearing))
		h.statsd.Gauge(1.0, fmt.Sprintf("heerhugowaard2.%s.cloud_cover", update.TimeStr), fmt.Sprintf("%d", update.CloudCover))
		h.statsd.Gauge(1.0, fmt.Sprintf("heerhugowaard2.%s.humidity", update.TimeStr), fmt.Sprintf("%d", update.Humidity))
		...
		h.statsd.Gauge(1.0, fmt.Sprintf("heerhugowaard2.%s.moon_illimination", update.TimeStr), fmt.Sprintf("%d", update.MoonIllumination))
		h.statsd.Gauge(1.0, fmt.Sprintf("heerhugowaard2.%s.uv_index", update.TimeStr), fmt.Sprintf("%f", update.UVIndex))
